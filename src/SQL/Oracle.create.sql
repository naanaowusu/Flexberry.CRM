...
(
	...
	"EmployerRole" NVARCHAR2(255) NULL,
...
(
	...
	"ActivityName" NVARCHAR2(255) NULL,

	"ActivityType" NVARCHAR2(17) NULL,
...
ALTER TABLE "Employer"
	ADD CONSTRAINT "Employer_FAdministrator_0" FOREIGN KEY ("Administrator_m0") REFERENCES "Administrator" ("primaryKey");
